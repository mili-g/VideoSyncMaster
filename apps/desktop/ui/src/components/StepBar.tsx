...
const StepBar: React.FC<StepBarProps> = ({ steps, activeStepKey, onStepChange, themeMode, compact = false, minimal = false }) => {
    ...
    return (
        <div style={{
            ...
            padding: minimal ? '4px 8px' : compact ? '8px 14px' : '12px 24px',
            background: isLightMode ? 'rgba(255, 255, 255, 0.5)' : 'rgba(15, 23, 42, 0.28)',
            backdropFilter: 'blur(20px)',
            borderRadius: minimal ? '12px' : compact ? '16px' : '20px',
            border: isLightMode ? '1px solid rgba(0,0,0,0.05)' : '1px solid rgba(255, 255, 255, 0.04)',
            boxShadow: minimal ? 'none' : '0 8px 32px rgba(0,0,0,0.1)',
            gap: minimal ? '8px' : compact ? '8px' : '12px',
            alignSelf: 'center',
            zIndex: 100,
                    ...
                    <React.Fragment key={index}>
                        <div
                            ...
                            style={{
                                ...
                                transform: isActive && !minimal ? 'translateY(-2px)' : 'none'
                            }}
                        >
                            <div style={{
                                ...
                                fontWeight: 'bold',
                                boxShadow: isActive && !minimal ? '0 0 15px rgba(99, 102, 241, 0.4)' : 'none'
                            }}>
                        ...
                        {index < steps.length - 1 && (
                            <div style={{
                                width: minimal ? '14px' : compact ? '16px' : '30px',
                                height: minimal ? '1px' : '2px',
