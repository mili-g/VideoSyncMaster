...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--ori_lang", type=str, help="Source language for ASR", default=None)
    ...
    parser.add_argument("--runtime_profile", type=str, help="Runtime profile: auto, current, qwen3, indextts, gptsovits", default="auto")
    parser.add_argument("--asr", type=str, help="ASR service to use: faster-whisper, funasr, qwen, vibevoice-asr, jianying, bcut", default="faster-whisper")
    parser.add_argument("--asr_model_profile", type=str, help="ASR model profile, e.g. balanced, quality, fast", default="")
    parser.add_argument("--faster_whisper_vad_filter", type=str, help="faster-whisper VAD filter: true or false", default="true")
    parser.add_argument("--faster_whisper_vad_threshold", type=float, help="faster-whisper VAD threshold", default=0.4)
    parser.add_argument("--funasr_batch_size_s", type=int, help="FunASR batch duration in seconds", default=300)
    parser.add_argument("--funasr_merge_vad", type=str, help="FunASR merge VAD segments: true or false", default="true")
    parser.add_argument("--local_asr_device", type=str, help="Unified local ASR device: auto, cuda, cpu", default="auto")
    parser.add_argument("--local_asr_max_inference_batch_size", type=int, help="Unified local ASR max inference batch size", default=32)
    parser.add_argument("--local_asr_max_new_tokens", type=int, help="Unified local ASR max new tokens", default=256)
    parser.add_argument("--qwen_device", type=str, help="Qwen3 ASR device: auto, cuda, cpu", default="auto")
    parser.add_argument("--qwen_max_inference_batch_size", type=int, help="Qwen3 ASR max inference batch size", default=32)
    parser.add_argument("--qwen_max_new_tokens", type=int, help="Qwen3 ASR max new tokens", default=256)
    ...
    parser.add_argument("--tts_service", type=str, help="TTS Service: indextts, qwen or gptsovits", default="indextts")
    parser.add_argument("--tts_model_profile", type=str, help="TTS model profile, e.g. standard, quality, fast", default="")
    parser.add_argument("--voice_mode", type=str, help="Voice mode: clone or narration", default="clone")
    parser.add_argument("--gpt_sovits_prompt_text", type=str, help="Prompt text matching the GPT-SoVITS reference audio", default="")
    parser.add_argument("--gpt_sovits_prompt_lang", type=str, help="Prompt language for GPT-SoVITS reference audio", default="")
    parser.add_argument("--gpt_sovits_text_split_method", type=str, help="GPT-SoVITS text split method", default="cut5")
    parser.add_argument("--gpt_sovits_speed_factor", type=float, help="GPT-SoVITS speed factor", default=1.0)
    parser.add_argument("--gpt_sovits_batch_threshold", type=float, help="GPT-SoVITS batch threshold", default=0.68)
    parser.add_argument("--gpt_sovits_parallel_infer", type=str, help="GPT-SoVITS parallel inference: true or false", default="true")
    parser.add_argument("--gpt_sovits_sample_steps", type=int, help="GPT-SoVITS sample steps", default=28)
    parser.add_argument("--gpt_sovits_official_fast_mode", type=str, help="GPT-SoVITS official fast path: true or false", default="true")
